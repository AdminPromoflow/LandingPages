...
/*  Created On : 08-Nov-2023 7:47:18 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS `Ammount`
;

DROP TABLE IF EXISTS `Attachments`
;

DROP TABLE IF EXISTS `AttachmentWith`
;

DROP TABLE IF EXISTS `ClipsAccessories`
;
...
DROP TABLE IF EXISTS `SidesPrinted`
;

DROP TABLE IF EXISTS `Texts`
;

DROP TABLE IF EXISTS `TimeDeliveries`
;

DROP TABLE IF EXISTS `Users`
;

DROP TABLE IF EXISTS `UsersLanyards`
;
...
(
	...
	`passwordUser` VARCHAR(90) NOT NULL,
